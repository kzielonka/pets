...
class AnnouncementsMap
  class TestBoundingBox < Minitest::Test
    ...
    def test_initialization_with_invalid_inputs
      assert_raises(AnnouncementsMap::BoundingBox::InvalidCoordinatesError) do
        AnnouncementsMap::BoundingBox.new('INVALID', 0.0, 10.0, 0.0)
      end
      assert_raises(AnnouncementsMap::BoundingBox::InvalidCoordinatesError) do
        AnnouncementsMap::BoundingBox.new(10.0, 'INVALID', 10.0, 0.0)
      end
      assert_raises(AnnouncementsMap::BoundingBox::InvalidCoordinatesError) do
        AnnouncementsMap::BoundingBox.new(10.0, 0.0, 'INVALID', 0.0)
      end
      assert_raises(AnnouncementsMap::BoundingBox::InvalidCoordinatesError) do
        AnnouncementsMap::BoundingBox.new(10.0, 0.0, 10.0, 'INVALID')
      end
    end
